...
function tema1_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function tema1_button($variables) {
 ...
 */
function tema1_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function tema1_menu_local_task($variables) {
 ...
 */
function tema1_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function tema1_node_preview($variables) {
  $node = $variables['node'];
